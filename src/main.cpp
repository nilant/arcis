...
int main(int argc, char* argv[]) {
    ...
    fmt::print("\nOptimizing {} with timelimit={}, vidal_iterlimit={}, mls_iterlimit={}, memlimit={}, threads={}, seed={}, multi={}\n",
               inst.name, args.timelimit, args.vidal_iterlimit, args.mls_iterlimit, args.memlimit, args.threads, args.seed, args.multi);
